// Variables; title, name, supervisors etc.
#let title = "Title Goes Here! An Analysis of Post-quantum Thesis Titles!"
#let name = "Hannes Hannus"
#let supervisors = "Hatt-Guss"
#let faculty = "Faculty of Things"
#let university = "University of Stuff"
#let thesis = "Master's Thesis in Things & Stuff"
#let year = 2025
...
// Source: https://github.com/typst/typst/issues/344#issuecomment-1518710375
#let code(
    enablebubble: false,       // Default to not having the text bubble at the top
    ...
    // This might be fixed in future Typst versions, but for now code blocks are not `locatable`
    // so we have to wrap this is an invisible table so we can locate it for the List of Lisitings
    // Source: https://github.com/typst/typst/discussions/1556#discussioncomment-6268977
    figure(kind: "code", supplement: "Listing", outlined: true, caption: caption)[
        #block(
        width: width,
        fill: bgcolor,
        stroke: strokecolor,
        ...
        clip: false,
        {
            ...
            if enablebubble and caption != none {
                style(styles => {
